...
class OrderForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['description'].widget.attrs.update({'placeholder': 'Please provide as much detail as possible.'})
        self.fields['size'].widget.attrs.update({'placeholder': 'Enter desired size, e.g. 297mm x 210mm.'})
